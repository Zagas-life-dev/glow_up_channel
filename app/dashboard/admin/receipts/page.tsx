...
export default function AdminReceiptsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'awaiting_verification': return 'bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-500/30'
  ...
  const getPackageColor = (packageType: string) => {
    switch (packageType) {
      case 'spotlight': return 'bg-purple-500/10 text-purple-700 dark:text-purple-400 border border-purple-500/30'
      case 'feature': return 'bg-primary/10 text-foreground'
      case 'launch': return 'bg-primary/10 text-primary border border-primary/30'
      case 'custom': return 'bg-pink-500/10 text-pink-700 dark:text-pink-400 border border-pink-500/30'
      default: return 'bg-muted text-foreground'
    }
  }
    ...
    return (
      <div className="min-h-screen bg-page flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground">Loading admin receipts...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <AdminShell
      title="Receipts"
      description="Payment receipts submitted by providers."
                        ...
                        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                          ...
                          <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <label className="text-sm font-medium text-foreground">Promotion Title</label>
                            ...
                            <div>
                              <label className="text-sm font-medium text-foreground mb-2 block">Receipt Image</label>
