...
//   job: { icon: 'briefcase', color: 'primary', label: 'Job' },
//   event: { icon: 'calendar', color: 'emerald', label: 'Event' },
//   resource: { icon: 'book', color: 'violet', label: 'Resource' }
// }
...
//     { label: 'Jobs', count: stats.savedJobs, icon: 'briefcase', color: 'primary' },
//     { label: 'Events', count: stats.savedEvents, icon: 'calendar', color: 'emerald' },
//     { label: 'Resources', count: stats.savedResources, icon: 'book', color: 'violet' },
//   ]
...
//                   <FlaticonIcon name="sparkles" className="w-6 h-6 text-orange-500" />
//                 </div>
//                 <div>
...
//                 <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-xs font-bold text-foreground">
...
//                   <Button size="sm" className="bg-primary hover:bg-primary/90 text-foreground rounded-xl">
//                     Complete Profile
//                     <FlaticonIcon name="arrow-right" className="w-4 h-4 ml-1" />
//                   </Button>
//                 </Link>
//               </div>
//             </div>
...
//             <FlaticonIcon name="exclamation" className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
//             <div className="flex-1">
...
//           <FlaticonIcon name="check-circle" className="w-5 h-5 text-emerald-500" />
//           <p className="text-sm text-emerald-400">{success}</p>
//         </div>
//       )}

//       {/* Tab Navigation */}
//       <div className="flex items-center gap-1 mb-6 p-1 rounded-xl bg-muted border border-border overflow-x-auto">
//         {tabs.map((tab) => {
...
//               <FlaticonIcon
//                 name={tab.icon}
//                 className={cn("w-4 h-4", isActive && "text-orange-500")}
//               />
//               {tab.label}
//             </button>
//           )
...
//             <Button size="sm" variant="ghost" className="text-orange-500 hover:text-orange-400 hover:bg-primary/10">
//               <FlaticonIcon name="crown" className="w-4 h-4 mr-2" />
//               Provider Hub
//             </Button>
//           </Link>
//         )}
...
//                       stat.color === 'orange' && "bg-primary/10",
...
//                   </div>
//                   <p className="text-xs text-muted-foreground">Saved {stat.label}</p>
//                 </div>
//               )
//             })}
//           </div>
...
//                   <FlaticonIcon name="trending-up" className="w-4 h-4 text-orange-500" />
//                 </div>
...
//                   See All
//                   <FlaticonIcon name="angle-right" className="w-4 h-4 ml-1" />
//                 </Button>
//               </Link>
//             </div>
...
//                       <div className="p-5 hover:bg-card transition-colors">
//                         <div className="flex items-start gap-4">
//                           <div className={cn(
//                             "w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0",
//                             config.color === 'orange' && "bg-primary/10",
...
//                                 <Badge variant="outline" className="border-0 bg-primary/10 text-orange-500 text-[10px] px-1.5 py-0">
//                                   {Math.round(item.score)}% match
//                                 </Badge>
//                               )}
//                             </div>
                            
//                             <h3 className="font-medium text-foreground group-hover:text-orange-400 transition-colors line-clamp-1">
//                               {item.title}
//                             </h3>
...
//                                 <FlaticonIcon name="map-marker" className="w-3 h-3" />
...
//                           <FlaticonIcon
//                             name="angle-right"
//                             className="w-5 h-5 text-muted-foreground group-hover:text-orange-500 group-hover:translate-x-1 transition-all flex-shrink-0"
//                           />
//                         </div>
//                       </div>
//                     </Link>
...
//                     <FlaticonIcon name="trending-up" className="w-6 h-6 text-muted-foreground" />
//                   </div>
//                   <h3 className="font-medium text-foreground mb-1">No Recommendations Yet</h3>
...
//             <div className="flex items-center gap-3">
//               <div className="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center">
//                 <FlaticonIcon name="bookmark" className="w-4 h-4 text-orange-500" />
//               </div>
//               <div>
...
//                           <h3 className="font-medium text-foreground group-hover:text-orange-400 transition-colors line-clamp-1 mt-0.5">
//                             {item.title}
//                           </h3>
...
//               <div className="p-12 text-center">
//                 <div className="w-14 h-14 rounded-2xl bg-muted flex items-center justify-center mx-auto mb-4">
//                   <FlaticonIcon name="bookmark" className="w-6 h-6 text-muted-foreground" />
//                 </div>
//                 <h3 className="font-medium text-foreground mb-1">No Saved Items Yet</h3>
//                 <p className="text-sm text-muted-foreground mb-4">Start exploring to save items you're interested in</p>
//                 <div className="flex flex-wrap justify-center gap-2">
//                   <Link href="/opportunities">
//                     <Button size="sm" variant="outline" className="border-border text-muted-foreground hover:text-foreground hover:border-border rounded-xl">
//                       <FlaticonIcon name="target" className="w-4 h-4 mr-1" />
//                       Opportunities
//                     </Button>
//                   </Link>
//                   <Link href="/jobs">
//                     <Button size="sm" variant="outline" className="border-border text-muted-foreground hover:text-foreground hover:border-border rounded-xl">
//                       <FlaticonIcon name="briefcase" className="w-4 h-4 mr-1" />
//                       Jobs
//                     </Button>
//                   </Link>
//                 </div>
...
//               <FlaticonIcon name="crown" className="w-8 h-8 text-orange-500" />
//             </div>
//             <h2 className="text-2xl font-bold text-foreground mb-2">Become an Opportunity Provider</h2>
//             <p className="text-muted-foreground mb-6 max-w-md mx-auto">
//               Share your opportunities with thousands of ambitious individuals
//             </p>
//             <Button onClick={handleUpgradeToProvider} size="lg" className="bg-primary hover:bg-primary/90 rounded-xl" disabled={isUpgrading}>
//               {isUpgrading ? 'Processing...' : 'Become a Provider'}
//               <FlaticonIcon name="arrow-right" className="w-5 h-5 ml-2" />
//             </Button>
//           </div>
...
//               { icon: 'chart-bar', title: 'Analytics', desc: 'Track engagement and performance' },
//             ].map((benefit) => (
//               <div key={benefit.title} className="p-5 rounded-2xl bg-card border border-border">
//                 <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
//                   <FlaticonIcon name={benefit.icon} className="w-5 h-5 text-orange-500" />
//                 </div>
...
//                   <div className="w-8 h-8 rounded-full bg-primary/10 text-orange-500 flex items-center justify-center text-sm font-semibold flex-shrink-0">
//                     {item.step}
//                   </div>
//                   <div>
...
//           <DialogHeader>
//             <DialogTitle className="text-foreground">Upgrade to Provider</DialogTitle>
...
//                 <FlaticonIcon name="exclamation" className="w-4 h-4 text-red-500 flex-shrink-0 mt-0.5" />
//                 <span className="text-sm text-red-400">{error}</span>
//               </div>
//             )}
            
//             <DialogFooter>
//               <Button type="button" variant="ghost" onClick={() => setShowUpgradeModal(false)} disabled={isUpgrading} className="text-muted-foreground">
//                 Cancel
//               </Button>
//               <Button type="submit" className="bg-primary hover:bg-primary/90" disabled={isUpgrading}>
