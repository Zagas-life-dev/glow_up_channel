    ...
    <div className="min-h-screen pb-24 md:pb-8">
        ...
        <div className="max-w-7xl mx-auto py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Link href="/dashboard" className="p-2 hover:bg-white/[0.05] rounded-lg transition-colors">
                <ArrowLeft className="h-5 w-5 text-white/60" />
              </Link>
              <div>
                <h1 className="text-2xl lg:text-3xl font-bold text-white">Analytics Dashboard</h1>
                <p className="text-sm lg:text-base text-white/60">Track your posting performance and insights</p>
              </div>
            </div>
            
            <div className="flex items-center space-x-3">
              <Select value={timeRange} onValueChange={setTimeRange}>
                <SelectTrigger className="w-32 h-11 rounded-xl bg-white/[0.05] border-white/[0.1] text-white">
                  <SelectValue />
                </SelectTrigger>
              ...
              <Button variant="outline" size="sm" className="border-white/10 text-white/70 hover:text-white hover:bg-white/[0.05] rounded-xl px-4 py-2">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          <Card className="border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300 rounded-2xl overflow-hidden group">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-white/60 mb-2">Total Views</p>
                  <p className="text-3xl font-bold text-white mb-2">{analyticsData.totalViews.toLocaleString()}</p>
                  <p className="text-sm text-emerald-400 flex items-center">
                    <TrendingUp className="h-4 w-4 mr-2" />
                    +12.5% from last month
                  </p>
                </div>
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-blue-500/30">
          ...
          <Card className="border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300 rounded-2xl overflow-hidden group">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-white/60 mb-2">Average Views per Posting</p>
                  <p className="text-3xl font-bold text-white mb-2">{analyticsData.averageViewsPerPosting}</p>
                  <p className="text-sm text-emerald-400 flex items-center">
                    <TrendingUp className="h-4 w-4 mr-2" />
                    +5.2% from last month
                  </p>
          ...
          <Card className="border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300 rounded-2xl overflow-hidden group">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-white/60 mb-2">Active Postings</p>
                  <p className="text-3xl font-bold text-white mb-2">{analyticsData.totalPostings}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
          {/* Posting Performance */}
          <Card className="border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300 rounded-2xl overflow-hidden lg:col-span-2">
            <CardHeader className="bg-white/[0.03] border-b border-white/[0.06]">
            ...
            <CardContent className="p-6">
              <div className="space-y-3">
                {postingStats.map((posting) => (
                  <div key={posting.id} className="group flex items-center justify-between p-4 bg-white/[0.03] rounded-xl hover:bg-white/[0.05] border border-white/[0.06] transition-all duration-300 cursor-pointer">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-medium text-white text-sm group-hover:text-orange-400 transition-colors">{posting.title}</h4>
                        <p className="text-xs text-white/50 capitalize">{posting.type}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-lg font-bold text-white">{posting.views.toLocaleString()}</div>
          ...
          {/* Recent Activity */}
          <Card className="border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300 rounded-2xl overflow-hidden">
            <CardHeader className="bg-white/[0.03] border-b border-white/[0.06]">
              <CardTitle className="flex items-center gap-2 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <Card className="border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] transition-all duration-300 rounded-2xl overflow-hidden">
            ...
            <CardContent className="p-6">
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-blue-500/10 rounded-xl border border-blue-500/20 hover:bg-blue-500/15 transition-all duration-300">
                  <div className="flex items-center space-x-3">
                  ...
                  <div className="text-right">
                    <p className="text-xl font-bold text-white">690</p>
                    <p className="text-xs text-white/50">55.4% of total</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-emerald-500/10 rounded-xl border border-emerald-500/20 hover:bg-emerald-500/15 transition-all duration-300">
                  ...
                  <div className="text-right">
                    <p className="text-xl font-bold text-white">389</p>
                    <p className="text-xs text-white/50">31.2% of total</p>
                  </div>
                </div>
                
                <div className="flex items-center justify-between p-4 bg-orange-500/10 rounded-xl border border-orange-500/20 hover:bg-orange-500/15 transition-all duration-300">
                  <div className="flex items-center space-x-3">
                  ...
                  <div className="text-right">
                    <p className="text-xl font-bold text-white">168</p>
                    <p className="text-xs text-white/50">13.4% of total</p>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="text-center py-6">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Growing Steadily</h3>
                  <p className="text-sm text-white/60 mb-4">
                    Your views have increased by 18% this month
                  </p>
                  <div className="grid grid-cols-4 gap-2 text-sm">
                    <div className="text-center p-2 bg-white/[0.05] rounded-lg border border-white/[0.1]">
                      <p className="font-semibold text-white">Week 1</p>
                      <p className="text-white/50">245</p>
                    </div>
                    <div className="text-center p-2 bg-white/[0.05] rounded-lg border border-white/[0.1]">
                      <p className="font-semibold text-white">Week 2</p>
                      <p className="text-white/50">312</p>
                    </div>
                    <div className="text-center p-2 bg-white/[0.05] rounded-lg border border-white/[0.1]">
                      <p className="font-semibold text-white">Week 3</p>
                      <p className="text-white/50">389</p>
                    </div>
                    <div className="text-center p-2 bg-white/[0.05] rounded-lg border border-white/[0.1]">
                      <p className="font-semibold text-white">Week 4</p>
                      <p className="text-white/50">456</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button asChild variant="outline" className="border-orange-500/30 text-orange-400 hover:bg-orange-500/10 hover:text-orange-300 px-8 py-3 rounded-full transition-all duration-300">
