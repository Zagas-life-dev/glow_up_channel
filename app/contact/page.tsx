              ...
              <Card className="border border-border bg-card">
                ...
                <CardContent>
                  <div className="flex space-x-4">
                    <a href="https://www.instagram.com/tochis.takes" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-orange-400 transition-colors">
                      <FlaticonIcon name="instagram" style="fi-brands" className="h-6 w-6" aria-hidden />
                      <span className="sr-only">Instagram</span>
                    </a>
                    <a href="https://www.linkedin.com/in/tochi-ifeanyi" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-orange-400 transition-colors">
                      <FlaticonIcon name="linkedin" style="fi-brands" className="h-6 w-6" aria-hidden />
                      <span className="sr-only">LinkedIn</span>
                    </a>
                    <a href="https://tiktok.com/@tochis.takes" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-orange-400 transition-colors">
