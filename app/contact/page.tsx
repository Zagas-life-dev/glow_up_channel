              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex space-x-4">
                    <a href="https://www.instagram.com/tochis.takes" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
                      <Instagram className="h-6 w-6" />
                      <span className="sr-only">Instagram</span>
                    </a>
                    <a href="https://www.linkedin.com/in/tochi-ifeanyi" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
                      <Linkedin className="h-6 w-6" />
                      <span className="sr-only">LinkedIn</span>
                    </a>
                    <a href="https://tiktok.com/@tochis.takes" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
