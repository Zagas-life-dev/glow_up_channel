        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="prose prose-sm max-w-none">
              <h4 className="font-semibold text-foreground mb-2">1. Platform Usage</h4>
              <p className="text-gray-600 mb-4">
                By using the UP platform, you agree to use it responsibly and in accordance with our community guidelines. 
                You are responsible for all content you post and the accuracy of information provided.
              </p>

              <h4 className="font-semibold text-foreground mb-2">2. Content Guidelines</h4>
              <p className="text-gray-600 mb-4">
              ...
              <h4 className="font-semibold text-foreground mb-2">3. Data Privacy</h4>
              <p className="text-gray-600 mb-4">
              ...
              <h4 className="font-semibold text-foreground mb-2">4. Verification Requirements</h4>
              <p className="text-gray-600 mb-4">
              ...
              <h4 className="font-semibold text-foreground mb-2">5. Platform Moderation</h4>
              <p className="text-gray-600 mb-4">
              ...
              <h4 className="font-semibold text-foreground mb-2">6. Liability and Disclaimers</h4>
              <p className="text-gray-600 mb-4">
